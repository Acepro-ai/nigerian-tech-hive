            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link
                ...
                className={`text-gray-700 hover:text-red-600 transition-colors ${
                  isActive('/testimonials') ? 'text-red-600 font-medium' : ''
                }`}
              >
                Testimonials
              </Link>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger className="flex items-center text-gray-700 hover:text-red-600 transition-colors">
                  Industries <ChevronDown className="ml-1 h-4 w-4" />
                </DropdownMenuTrigger>
                <DropdownMenuContent className="bg-white">
                  <DropdownMenuItem asChild>
                    <Link to="/industries/gaming" className="w-full">Gaming</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link to="/industries/fintech" className="w-full">Fintech</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link to="/industries/software" className="w-full">Software and Services</Link>
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
              ...
              <Link
                ...
                className={`text-gray-700 hover:text-red-600 transition-colors ${
                  isActive('/hire-nigerian-experts') ? 'text-red-600 font-medium' : ''
                }`}
              >
              ...
              <Link
                to="/job-seekers"
                className={`text-gray-700 hover:text-red-600 transition-colors ${
                  isActive('/job-seekers') ? 'text-red-600 font-medium' : ''
                }`}
              >
                Job Seekers
              </Link>
              ...
              <Link
                to="/blog"
                className={`text-gray-700 hover:text-red-600 transition-colors ${
                  isActive('/blog') ? 'text-red-600 font-medium' : ''
                }`}
              >
                Blog
              </Link>
            ...
            <div className="md:hidden py-4 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Link
                  ...
                  className="block pl-4 text-gray-600 hover:text-red-600 transition-colors"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Gaming
                </Link>
